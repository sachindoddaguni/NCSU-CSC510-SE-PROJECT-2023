...
| Question 2.1: Is the name of your project/software unique? |  4| Name was unique.|
| Question 2.2: Is your project/software name free from trademark violations? |  3|  Did not find anything with the exact name, although there seems to be facebook business pages with same name.|
| Question 3.1: Is your software available as a package that can be deployed without building it? |  3|  No
| Question 3.2: Is your software available for free? |  5|  Available on GH public repository for anyone to access|
| Question 3.3: Is your source code publicly available to download, either as a downloadable bundle or via access to a source code repository? |  5|  Available on GH public repository for anyone to access|
| Question 3.4: Is your software hosted in an established, third-party repository like GitHub (https://github.com), BitBucket (https://bitbucket.org),LaunchPad (https://launchpad.net) orSourceForge (https://sourceforge.net)?  |  5|  Yes, can be found on GitHub [repo](https://github.com/rliu9/cheapBuy)
| Question 4.1: Is your documentation clearly available on your website or within your software? |  3|  Yes, but can be better. [link](https://github.com/rliu9/cheapBuy/blob/main/README.md)
| Question 4.2: Does your documentation include a "quick start" guide, that provides a short overview of how to use your software with some basic examples of use? |  3|  Yes. There are installation steps in the README.md file [link](https://github.com/rliu9/cheapBuy/blob/main/README.md)
| Question 4.3: If you provide more extensive documentation, does this provide clear, step-by-step instructions on how to deploy and use your software? | 2 | Somewhat, as there seems no information about deployment in the documentaion file [here](https://github.com/rliu9/cheapBuy/blob/main/README.md) |
| Question 4.4: Do you provide a comprehensive guide to all your software's commands, functions and options? | 1 | No, guide is not comphrehensive. [link](https://github.com/rliu9/cheapBuy/blob/main/README.md) |
...
| Question 4.6: If your software can be used as a library, package or service by other software, do you provide comprehensive API documentation? | 1 | No API level documentation found |
| Question 4.7: Do you store your documentation under revision control with your source code? | 3 | Yes |
| Question 4.8: Do you publish your release history e.g. release data, version numbers, key features of each release etc. on your web site or in your documentation? | 0 | No release notes or key features |
| Q5 - How you support your software | not applicable  |  |
| Question 5.1: Does your software describe how a user can get help with using your software? | 2 | Video provides a brief walkthrough on how to use the application|
...
| Question 5.4: Are e-mails to your support e-mail address received by more than one person? | 0 | Information not given |
| Question 5.5: Does your project have a ticketing system to manage bug reports and feature requests? | 3 | There seems to be tickets created to track bugs and features. |
| Question 5.6: Is your project's ticketing system publicly visible to your users, so they can view bug reports and feature requests? | 4 | Yes |
| Question 6.1: Is your software's architecture and design modular? | 1 | Single file contains all code [here] |
| Question 6.2: Does your software use an accepted coding standard or convention? | 3 |Their code has a CODE_OF_CONDUCT.md file which describes the coding standards and conventions. [here](https://github.com/het-patel99/cheapBuy/blob/main/CONTRIBUTING.md) |  |  |
...
| Question 7.2: Does your software allow communications using open communications protocols? e.g. HTTP, FTP, XMPP, SOAP over HTTP, or domain-specific ones | 3 |Code communicates over HTTPS to web scrape  |
| Q8 - Your software's portability |  |  |
| Question 8.1: Is your software cross-platform compatible? *e.g. does it run under two or more of Windows, Unix/Linux and Mac OS X, or can be used from within two or more of Internet Explorer, Chrome, Firefox and Safari? | 3 |Yes as it can be set up for multiple systems/browsers as multiple python envs can be setup. |
...
| Question 9.2: Does your documentation adhere to appropriate accessibility conventions or standards? | 0 | The documentation does not adhere to conventions/standards |
| Q10 - How you manage your source code |  |  |
| Question 10.1: Is your source code stored in a repository under revision control? | 3 |Software in stored in GitHub repo [here](https://github.com/rliu9/cheapBuy) |
